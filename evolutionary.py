...
class Evolution_Solution(Strategy):
	...
	def approach(self,pop_size=100,top_k=5):
		population = [self.flatten(self.get_initial_solution()) for i in range(pop_size)]
	...
	def recombine(self,solution_1,solution_2,p=0.05): #Should i use numpy arrays??? (This applies to the swap approach too)
		# segment_length = 
